    ...
    <table class="nav-justified" style="display: flex; width: 50%; margin: 0 auto 0 auto;">
        <tr>
            <td style="width: 260px; height: 24px;">
                ...
                Nome
                <br />
                <asp:TextBox ID="TextBox5" runat="server" Font-Size="Medium" Width="250px"></asp:TextBox>
            </td>

            <td style="height: 24px; width: 260px;">
                <br />
                CPF<br />
                <asp:TextBox ID="TextBox6" runat="server" Font-Size="Medium" Width="250px" Style="margin-left: 0"></asp:TextBox>
            </td>
        ...
        <tr>
          ...
          <tr>
            <td style="width: 260px; height: 24px;">Rua
                <br />
                <asp:TextBox ID="TextBox7" runat="server" Font-Size="Medium" Width="250px"></asp:TextBox>
            </td>

            <td style="height: 24px; width: 263px;">Número<br />
                <asp:TextBox ID="TextBox8" runat="server" Font-Size="Medium" Width="250px" Style="margin-left: 0"></asp:TextBox>
            </td>
        </tr>
        ...
        <tr>
            <td class="modal-sm" style="width: 260px">
                ...
                Cep
                <br />
                <asp:TextBox ID="TextBox9" runat="server" Font-Size="Medium" Width="250px"></asp:TextBox>
            </td>
            <td style="width: 263px" class="modal-sm">
                <br />
                Bairro
                <br />
                <asp:TextBox ID="TextBox10" runat="server" Font-Size="Medium" Width="250px"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td class="modal-sm" style="width: 260px">
                ...
                Cidade
                <br />
                <asp:TextBox ID="TextBox11" runat="server" Font-Size="Medium" Width="250px"></asp:TextBox>
            </td>
           <td style="width: 127px; height: 32px;">
               <br />
               Estado<br />
                <asp:DropDownList ID="DropDownList2" runat="server" Height="28px" Width="80px">
